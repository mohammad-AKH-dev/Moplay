...
function SliderTvShowBox(props: TvShowPropsType) {
  ...
  return !isLoaded ? (
    ...
    >
      ...
      <div className="tv-show-detailes overflow-hidden mt-4">
        <h4 className="tv-show-title w-[220px] mn:w-[150px] sm:w-[226px] h-[27px] text-[18px] font-bold skeleton text-ellipsis overflow-hidden tracking-widest whitespace-nowrap"></h4>
        <div className="tv-show-time flex flex-wrap gap-x-2 flex-row mn:flex-col gap-y-[1rem] sm:flex-row justify-between mt-2 text-[16px]">
    ...
    >
      ...
      <div className="tv-show-detailes overflow-hidden mt-4">
        <h4 className="tv-show-title text-[18px] font-bold text-ellipsis overflow-hidden tracking-widest whitespace-nowrap">
          {title}
        </h4>
        <div className="tv-show-time flex flex-wrap gap-x-2 flex-row mn:flex-col sm:flex-row justify-between mt-2 text-[16px]">
